...
Create a [notebook](notebook.md) to host your notes. You are free to organize
...
[create a new note](note-creation.md) and write on!
...
After some time, hopefully you will have enough notes to be lost in it. Use
`zk`'s powerful [filtering capabilities](note-filtering.md) to find the notes
you need.
...
`zk` is aware of the links you set between your notes. You can use the linking
options to find the backlinks or outbound links of a note. It even supports
listing indirect links thanks to `--recursive`.
...
[filtering options](note-filtering.md) as `zk list`.
...
Declaring your own [aliases](config-alias.md) is a great way to make your
